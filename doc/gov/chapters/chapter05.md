...
Consensus decision making  model has been adopted by Anuket CNTT, as community buy in from all member organisations is essential for the success of the Anuket CNTT workgroup. 
...
Each Anuket CNTT member organisation shall nominate a single voting representative. A list of voting representatives shall be maintained within Anuket CNTT<sup>1</sup>.
...
1. to have attended at least **five** Anuket CNTT meetings in the 3 months period prior to the voting event;
...
<sup>1)</sup>https://github.com/cntt-n/Anuket CNTT/wiki/Voting-Representatives

<sup>2)</sup>Prior to the comencement of the vote for a given issue, the criteria will be checked and the voting representative list will be updated.
