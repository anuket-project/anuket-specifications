...
<a name="1.3"></a>
## 1.3 Terminology
The general terminology, except for this Reference ARchitecture specific terms, can be found [CNTT Reference Model Terminology](../../../ref_model/chapters/glossary.md#1.1); this Reference Architecture terms will be defined where used. 
