...
Section contains the APIs versions and key differences between the chosen Anuket CNTT baseline version (Train), the current version for RI (Ocata) and the potential future version for RI (Stein).
...
| Service Name | OpenStack (Ocata) (RI version) | OpenStack (Train) (Anuket CNTT baseline) | OpenStack (Stein) (potential future RI version) |
| --- | --- | --- | --- |
