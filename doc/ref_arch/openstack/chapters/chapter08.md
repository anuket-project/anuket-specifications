...
From the short term point of view, we could use ONAP to deal with this gap. However, for a long term point of view, reliance on ONAP should be avoided and the OpenStack APIs should be implemented/enhanced to address this gap.
