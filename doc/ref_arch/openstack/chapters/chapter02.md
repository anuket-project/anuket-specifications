...
| `req.inf.ntw.07` | Network | The Architecture **must** support network resiliency by [maintaining an acceptable level of service in the face of faults and challenges to normal operation](https://en.wikipedia.org/wiki/Resilience_(network)). | [RA-1 3.4.2.2. "Network"](./chapter03.md#3422-network) |
