...
| `req.int.api.05` | API | The Architecture **must** provide APIs to access to the network management service and all associated mandatory features selected for the CNTT conformance of the given OpenStack release and detailed in chapter 5 | [RA-1 5.2.5 "Neutron"](./chapter05.md#525-neutron) |
| `req.int.api.06` | API | The Architecture **must** provide APIs to access to the compute resources management service and all associated mandatory features selected for the CNTT conformance of the given OpenStack release and detailed in chapter 5 | [RA-1 5.2.6 "Nova"](./chapter05.md#526-nova) |
