...
#. **Open-source preference:** To ensure, by building on technology
available in open-source projects, that suppliers’ and operators’
investment have a tangible pathway towards a standard and
production ready Cloud Infrastructure solution portfolio.
...
#. **Automated lifecycle management:** To minimize costs of the
...
this reference architecture. Finally, Chapter 8 identifies certain Gaps
