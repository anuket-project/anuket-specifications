...
| `req.inf.ntw.11` | Network | The networking solution **should** be configurable in an automated manner using openly published API definitions. |
| `req.inf.ntw.12` | Network | The networking solution **should** be able to be centrally administrated and configured. |
...
| `req.cim.04` | General | The Architecture **must** include kubernetes artefacts (e.g., images, Helm charts, etc.) repository capabilities. |
