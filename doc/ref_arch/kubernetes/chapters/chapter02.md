...
| `req.inf.ntw.17` | Network | The Architecture **must** support cluster wide coordination of IP address assignement. |
| `req.inf.ntw.18` | Network | The Architecture **should** support the usage of any interfaces with a Kubernetes Service if the interface is designed to work with Kubernetes Services. |
