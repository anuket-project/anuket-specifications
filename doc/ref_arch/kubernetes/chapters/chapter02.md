...
| `req.inf.ntw.11` | Infrastructure |	Network | The networking solution to support multiple connection points (e.cap.004 - please see [Section 2.2.1](#2.2.1)) must conform to the Kubernetes Networking CRD de-facto standard ([K8S Network Plumbing Working Group](https://github.com/k8snetworkplumbingwg/community); [CRD](https://docs.google.com/document/d/1Ny03h6IDVy_e_vmElOqR7UdTPAG_RNydhVE1Kx54kFQ/edit)). | |
...
| `req.inf.ntw.13` | Infrastructure | Network | A tenant must specify at least one IP pool that is different from the control infrastructure IP pool or other tenant IP pools. | |
