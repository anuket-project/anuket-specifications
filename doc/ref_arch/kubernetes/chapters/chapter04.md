...
|`ra2.k8s.012`|Kubernetes API-s|Kubernetes [Alpha features](https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/#feature-stages) are recommended only for testing, therefore all Alpha features **must** be disabled.|[req.int.api.03](./chapter02.md#22-reference-model-requirements)||
