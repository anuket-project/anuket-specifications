...
To support `req.sec.gen.04`m the architecture should support the usage of a container runtime with the capability of Kernel isolation:
- kata-containers
...
To fulfill `req.sec.gen.05` the architecture must support the usage of the Kubernetes CPU Manager and to support the isolation of workload resources from the infrastructure resources [CPU Pooler](https://github.com/nokia/CPU-Pooler/).
