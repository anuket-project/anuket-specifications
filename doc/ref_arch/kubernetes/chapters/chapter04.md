...
|`ra2.ntw.008`|SR-IOV Device Plugin for Network Intensive|When hosting workloads matching the Network Intensive profile, a Device Plugin for SR-IOV may be used to configure the SR-IOV devices and advertise them to the `kubelet`.|[`e.cap.013`](chapter02.md#221-cloud-infrastructure-software-profile-capabilities)|
...
|`ra2.ntw.010`|User plane networking|When hosting workloads matching the Network Intensive profile, a CNI network plugin that supports the use of DPDK, VPP, or SR-IOV must be deployed as part of the networking solution.|[`infra.net.acc.cfg.001`](chapter02.md#223-cloud-infrastructure-software-profile-requirements)|
