...
|--------|-----------|--------------|------------|---------|
| Kick-Off | M0 | The goal of the release Kick-Off is to open the innovation platform for the intention to participate in the CNTT release. Release Kick-Off review takes place for each release. | Identify a list of features and functionality will be documented and developed. | |
