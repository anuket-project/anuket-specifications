...
|--------|-----------|--------------|------------|---------|
| Kick-Off | M0 | The goal of the release Kick-Off is to open the innovation platform for the intent to participate in the CNTT release. Release Kick-Off review takes place for each releases. | Identity a list of features and functionality will be documented and developed. | |
...
| Issue Logging Freeze | M2 | The goal of the Issue Logging Freeze is to mark the end of adding new issues in the Release. |  All the project leads authorise the issues are correctly labelled, mapped to the corresponding project and milestone, etc., | |
