...
- Provide details, preferably in table format, comparing OpenStack releases based
  on Train baseline for Anuket RI-1 (e.g. Train, Ussuri, etc)
...
proposed in
[new RI deployment container](https://github.com/cntt-n/Anuket/issues/828).
...
related issues:
- [port YardStick testcases to Xtesting](https://github.com/cntt-n/Anuket/issues/509)
- [port Bottlenecks to Xtesting](https://github.com/cntt-n/Anuket/issues/511)
- [port StorPerf testcases to Xtesting](https://github.com/cntt-n/Anuket/issues/673)
- [port NFVbench testcases to Xtesting](https://github.com/cntt-n/Anuket/issues/865)
...
| issues                                                                                            | requirements      |
|---------------------------------------------------------------------------------------------------|-------------------|
| [update and integrate heat-tempest-plugin in Functest](https://github.com/cntt-n/Anuket/issues/483) | Heat API testing  |
| [integrate KloudBuster in Functest](https://github.com/cntt-n/Anuket/issues/508)                    | disk benchmarking |
| [add tempest-stress in Functest](https://github.com/cntt-n/Anuket/issues/916)                       | stress testing    |

<a name="8.5"></a>
## 8.5 Framework Gaps

As proposed in [port VTP test cases to Xtesting](https://github.com/cntt-n/Anuket/issues/917),
VTP selected in
