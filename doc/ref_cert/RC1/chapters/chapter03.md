...
# 3. Cloud Infrastructure Test Cases and Traceability to Anuket CNTT Requirements
...
From a Anuket CNTT Compliance state point, the capabilities are well described in
...
have been proposed for Anuket CNTT Compliance which simply override the default test
...
verify OpenStack Train selected by Anuket CNTT:
...
as integrated in
[Functest Smoke Anuket CNTT](https://git.opnfv.org/functest/tree/docker/smoke-cntt/testcases.yaml?h=stable%2Fjerma).
...
[Functest Smoke Anuket CNTT](https://git.opnfv.org/functest/tree/docker/smoke-cntt/testcases.yaml).
...
[Functest Benchmarking Anuket CNTT](https://git.opnfv.org/functest/tree/docker/benchmarking-cntt/testcases.yaml?h=stable%2Fjerma)
...
the following test cases must pass as they are for Anuket CNTT NFVI
Conformance:
