...
[Chapter 7 of Reference Model](https://cntt.readthedocs.io/en/stable-lakelse/ref_model/chapters/chapter07.html).
...
- Profiles are offered to VNFs as an instance types with predefined compute flavors.
  ...
  - Compute flavors: .tiny, .small etc as defined in [RM §4.2.1.1](https://cntt.readthedocs.io/en/stable-lakelse/ref_model/chapters/chapter04.html#basic-profile)
- NFVI performance profiles, for which NFVI validations will support and be verified against, are defined as basic and network intensive. Details for each of these profiles can be found in [RM §2.3](https://cntt.readthedocs.io/en/stable-lakelse/ref_model/chapters/chapter02.html#analysis).

![NFVI Profiles](https://cntt.readthedocs.io/en/stable-lakelse/ref_model/figures/RM-ch04-node-profiles.png)
...
To cater to different needs from multiple NFVI vendors, Anuket allows different types of NFVI Conformance based on their types of [profile](https://cntt.readthedocs.io/en/stable-lakelse/ref_model/chapters/chapter02.html#analysis)
...
- API compliance: This is the most relevant type of test case, validating the functional correctness of the system under test. API compliance test cases exercise only the specific well-defined APIs described in the reference architecture (see [Interfaces and APIs](https://cntt.readthedocs.io/en/stable-lakelse/ref_arch/openstack/chapters/chapter05.html)).
...
Section [Infrastructure Profiles Catalogue](https://cntt.readthedocs.io/en/stable-lakelse/ref_model/chapters/chapter04.html#profiles-and-workload-flavours) of the reference model defines two software profiles, targeting two different use cases:

- Basic
- Network intensive

The test cases selected for validating compliance of the two profiles must cover the functional and non-functional requirements as listed in Section [Instance Capabilities Mapping](https://cntt.readthedocs.io/en/stable-lakelse/ref_model/chapters/chapter04.html#virtual-network-interface-specifications) and Section [Instance Performance Measurement Mapping](https://cntt.readthedocs.io/en/stable-lakelse/ref_model/chapters/chapter04.html#storage-extensions) of the reference model.
