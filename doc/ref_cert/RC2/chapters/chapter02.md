...
single tests:
  ...
  - skip excludes the SIG labels listed as optional in
    [Reference Architecture-2 (RA-2) Chapter 6](https://cntt.readthedocs.io/en/stable-lakelse/ref_arch/kubernetes/chapters/chapter06.html)
...
and [Reference Architecture-2 (RA-2) Chapter 6](https://cntt.readthedocs.io/en/stable-lakelse/ref_arch/kubernetes/chapters/chapter06.html)
for more details.
...
[Kubernetes based Reference Architecture](https://cntt.readthedocs.io/en/stable-lakelse/ref_arch/kubernetes/)
