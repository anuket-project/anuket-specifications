...
The RC2 test suite will provide validation to ensure workloads can interoperate with the CNTT RA2 infrastructure. Upstream projects will define features/capabilities, test scenarios, and test cases to be executed. 3rd Party test platforms may also be leveraged, if desired.
