...
1. RI2 serves as a baseline and proving ground for the [Reference Architecture 2 (RA2) specification](../../../ref_arch/kubernetes). It is verified through the [Reference Conformance 2 (RC2) specification](../../../ref_cert/RC2).
