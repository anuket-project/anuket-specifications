...
The Anuket CNTT Reference Model will be referenced as **RM** to avoid long and duplicated reference titles.
...
> Open Point 1: Does ONAP have some relevant spec or VNF declaration schema so that Anuket CNTT can re-use/revise to cover what we need ? Or define a new one ?
