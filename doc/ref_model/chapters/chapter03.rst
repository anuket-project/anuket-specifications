...
+----+----+----+----------+----+-----------------------------------------------------+
| **Satellite Data-**     | Satellite data-centre is a smaller regional  deployment  |
| **centre Storage**      | which has connectivity to and utilises resources         |
...
|    |    | site? Follow guidance as per "Satellite Data-centre Storage" use case(1).|
|    +----+----+----------+----+-----------------------------------------------------+
