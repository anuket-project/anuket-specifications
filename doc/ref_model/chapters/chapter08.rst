...
- the component clouds perform their local operations (internal requests) while also participating in the federation and
  ...
  - the component clouds are autonomous in terms of, for example, execution autonomy; please note that in a centralised
    ...
    /edge-computing-next-steps-in-architecture-design-and-testing/>`__" whitepaper :cite:p:`openinfraedgearch_rm`) the edge clouds do not have
...
(Operator Platform Telco Edge Requirements v2.0 :cite:p:`gsmaopg02_rm`)
...
FS.40 v2.0 document :cite:p:`gsmafs40_rm`.
...
As described in Sec. 1 (Scope) of the TS 103 457 document :cite:p:`etsits103sp457_rm`, it specifies "… a high-level service-oriented interface, as
