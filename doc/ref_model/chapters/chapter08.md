...
## 8.1 Hybrid Multi-Cloud Architecture
...
### 8.1.1 Characteristics of a Federated Cloud
...
Type | System Developer | System Maintenance | System Operated & Managed by | Location 
where Deployed | Primary Resource Consumption Models
---|---|---|---|---|---
...
### 8.1.3 Telco Operator Platform Conceptual Architecture
