...
- **Basic**: for Workloads [VNFCs/Micro-service] that can tolerate resource over-subscription and variable latency.
- **Network Intensive**: for Workloads [VNFCs/Micro-service] that require predictable computing performance, high network throughput and low network latency.
...
>- **Compute Intensive**: for Workloads [VNFCs/Micro-service]  that require predictable computing performance and low network latency.
>- ***Storage Intensive**: for Workloads [VNFCs/Micro-service] that require low storage latency and/or high storage IOPS.*
>- ***Enhanced Compute Intensive**: for compute intensive Workloads [VNFCs/Micro-service]  that require higher computing performance and/or specific compute resource (e.g., GPU).*
>- ***Enhanced Network Intensive**: for network intensive Workloads [VNFCs/Micro-service]  that require higher network performance and/or specific network resource (e.g., crypto acceleration).*
