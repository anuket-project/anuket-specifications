...
On **Chapter 4** later in the document, these infrastructure profiles will be offered to VNFs: **B (Basic)** and **N (Network intensive)** <!--, and **C (Compute intensive)** --> respectively.
