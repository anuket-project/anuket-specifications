...
- **Virtual Network Function Component (VNFC)**: component of a **VNF**, which is either a **V-VNFC** or a **C-VNFC**
- **VM-based VNFC (V-VNFC)**: **VNFC** hosted on a **VM** and in most cases, a single **V-VNFC** is hosted on a single **VM**
- **Container-based VNFC (C-VNFC)**: **VNFC** hosted on a **Container** and in most cases, a single **C-VNFC** is hosted on a single **Container**
