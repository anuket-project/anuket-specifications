...
ETSI GS NFV-IFA 002 :cite:p:`etsigsnfvifa002_rm` defines a technology and implementation independent virtual accelerator, the accelerator
interface requirements and specifications that would allow a workload to leverage a Virtual Accelerator. The virtual
accelerator is modelled on extensible para-virtualised devices (EDP). ETSI GS NFV-IFA 002 :cite:p:`etsigsnfvifa002_rm` specifies the
...
ETSI NFV-IFA 019 3.1.1 :cite:p:`etsinfvifa019_rm` has defined a set of technology independent interfaces for acceleration resource life cycle
...
interface, ETSI GS NFV-INF 004 :cite:p:`etsigsnfvinf004_rm` defines a set of requirements and details of the information that is required by the
