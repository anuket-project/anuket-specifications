...
Each Virtualization Infrastructure instances Overlay Network must support a basic primary communication channel in between the individual virtual compute instances in the tenants virtualized cluster. Due to the nature of Telecom applications handling of Networks and their related Network Functions they often need access to external non-translated traffic flows and have multiple separated or secondary traffic channels with abilities for different traffic treatments.
