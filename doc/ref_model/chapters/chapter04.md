...
| e.nfvi.cap.008 | GPU/NPU<sup>2)</sup> | Yes/No | Hardware coprocessor |
| e.nfvi.cap.008 | SmartNIC<sup>2)</sup> | Yes/No | Network Acceleration |
| e.nfvi.cap.008 | FPGA/other Acceleration H/W<sup>2)</sup> | Yes/No | Non-specific hardware |
