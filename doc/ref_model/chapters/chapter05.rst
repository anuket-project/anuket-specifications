...
+=============+=======================================================================+=========================================================================+
| pas.mon.001 | The Monitoring service must be able to collect data generated by or   | Capabilities to monitor applications, services, operating systems,      |  
|             | collected from any resource (physical and virtual infrastructure,     | network protocols, system metrics and infrastructure components         |
