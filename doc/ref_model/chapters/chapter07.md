...
In mobile network field, the GSM Association ([GSMA](https://www.gsma.com/)) and its Fraud and Security working group developed a strong expertise to secure the global mobile ecosystem. 
...
GSMA security activities are currently intense around 5G services and the new challenges raised by network functions virtualisation and open source software. The 2 following documents are in the scope of Cloud Infrastructure security:
