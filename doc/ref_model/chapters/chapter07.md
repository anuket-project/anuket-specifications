...
The CNTT scope is shown below (as outlined in chapter 1 of the reference model): :

![Image of ETSI NFV Mapping](https://github.com/cntt-n/CNTT/blob/master/doc/ref_model/figures/ch01_etsi_archi_mapping_v2.PNG)
