...
- [7 Security](#7-security)
  ...
  - [7.2 Principles and Guidelines](#72-principles-and-guidelines)
    - [7.2.1 Overarching Objectives and Goals](#721-overarching-objectives-and-goals)
    - [7.2.2 Verification Methodologies](#722-verification-methodologies)
    - [7.2.3 Governance](#723-governance)
  - [7.3 Common standards](#73-common-standards)
  - [7.3.1 Potential attack vectors.](#731-potential-attack-vectors)
  - [7.3.2 Testing demarcation points.](#732-testing-demarcation-points)
  - [7.4 Security Scope](#74-security-scope)
  - [7.4.1 In-scope and Out-of-Scope definition](#741-in-scope-and-out-of-scope-definition)
  - [7.4.2 Security Requirements](#742-security-requirements)
  - [7.4.3 Platform security requirements](#743-platform-security-requirements)
  - [7.4.4 Workload security requirements](#744-workload-security-requirements)
  - [7.4.5 Certification/validation requirements](#745-certificationvalidation-requirements)
  - [7.5 Platform Security](#75-platform-security)
  - [7.5.1 Platform Security](#751-platform-security)
- [The following security requirements apply to the platform:](#the-following-security-requirements-apply-to-the-platform)
  - [7.5.2 Platform ‘back-end’ access security](#752-platform-back-end-access-security)
  - [7.5.3 Platform ‘front-end’ access security](#753-platform-front-end-access-security)
  - [7.5.4 Platform services](#754-platform-services)
  - [7.6 Workload Security](#76-workload-security)
  - [7.7 Vendor Responsibilities](#77-vendor-responsibilities)
    - [7.7.1 Software Hardening](#771-software-hardening)
    - [7.7.2 Port Protection](#772-port-protection)
    - [7.7.3 Software Code Quality](#773-software-code-quality)
    - [7.7.4 Alerting and monitoring](#774-alerting-and-monitoring)
    - [7.7.5 Logging](#775-logging)
    - [7.7.6 VNF images](#776-vnf-images)
    - [7.7.7 Identity and Access Management](#777-identity-and-access-management)
    - [7.7.8 CVEs and Vulnerability Management](#778-cves-and-vulnerability-management)
    - [7.7.9 Encryption suite support](#779-encryption-suite-support)
    - [7.7.10 Password complexity support](#7710-password-complexity-support)
    - [7.7.11 Banner](#7711-banner)
  - [7.8 Operator responsibility.](#78-operator-responsibility)
    - [7.8.1 Remote Attestation/openCIT](#781-remote-attestationopencit)
    - [7.8.2 VNF Image Scanning / Signing](#782-vnf-image-scanning--signing)
  - [7.9 VNF Vendors responsibility.](#79-vnf-vendors-responsibility)
  - [7.10 NFVI and VIM Vendors responsibility](#710-nfvi-and-vim-vendors-responsibility)
    - [7.10.1 Networking Security Zoning](#7101-networking-security-zoning)
    - [7.10.2 Encryption](#7102-encryption)
    - [7.10.3 Platform Patching](#7103-platform-patching)
    - [7.10.4 Boot Integrity Measurement (TPM)](#7104-boot-integrity-measurement-tpm)
    - [7.10.5 NFVI & VIM](#7105-nfvi--vim)
  - [7.11 Certification requirements (Just ideas)](#711-certification-requirements-just-ideas)
