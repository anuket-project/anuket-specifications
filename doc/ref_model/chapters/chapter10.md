...
O-RAN Alliance (https://www.o-ran.org) is developing a common abstraction and programming model for RAN application domain (see https://www.o-ran.org/specificationsO-RAN document for Acceleration Abstraction Layer General Aspects an Principles 1.0 - November 2020 (O-RAN.WG6.AAL-GAnP-v01.00)). P4 Language Consortium (https://p4.org/) defines specifications for switching and routing domains. There is, however, a lack of a common programming model for accelerator applications development.
